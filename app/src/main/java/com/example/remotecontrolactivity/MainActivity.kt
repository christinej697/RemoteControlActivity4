...
class MainActivity : AppCompatActivity() {
    ...
    private var myHandler: android.os.Handler? = null
    ...
    protected fun onCreate(savedInstanceState: Bundle) {
        ...
        forBtn = findViewById(R.id.forButton) as Button           //these are onTouch
        backBtn = findViewById(R.id.backButton) as Button
        leftBtn = findViewById(R.id.leftButton) as Button
        rightBtn = findViewById(R.id.rightButton) as Button
        stopBtn = findViewById(R.id.stopButton) as Button          //this is onClick
